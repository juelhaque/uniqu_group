...
@section('content')
    <section class="content-header">
        <div class="container-fluid my-2">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Hotel & Resort Information Update</h1>
                </div>
        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-body table-responsive p-0">
                    <div class="p-3">
                        <form action="{{ route('hotel.update', $hotelResort->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <img id="img-preview" src="{{ asset($hotelResort->image)}}" width="250px" height="180px" />
                                </div>
                            </div>
                            <br>
