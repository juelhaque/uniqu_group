...
@section('content')
    <section class="content-header">
        <div class="container-fluid my-2">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Hotel & Resort Information</h1>
                </div>
                <div class="col-sm-6 text-right">
                    <a href="{{ route('hotel.create') }}" class="btn btn-primary">New Hotel & Resort</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            <div class="card">
                                ...
                                @foreach ($hotelResort as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('hotel.delete', $item->id) }}"
                ...
                <div class="card-footer clearfix d-flex justify-content-end">
                    {{ $hotelResort->links('pagination::bootstrap-4') }}
                </div>
            </div>
        </div>
        <!-- /.card -->
