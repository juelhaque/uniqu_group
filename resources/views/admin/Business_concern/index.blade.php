...
@section('content')
    <section class="content-header">
        <div class="container-fluid my-2">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Business Entities Information</h1>
                </div>
                <div class="col-sm-6 text-right">
                    <a href="{{ route('business.create') }}" class="btn btn-primary">New Business concern</a>
                </div>
            </div>
        </div>
        <!-- /.container-fluid -->
                    ...
                    <div>
                        <table class="table table-hover table-striped text-nowrap">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Business concern Name</th>
                                    <th>Business concern Link</th>
                                    <th>Image</th>
                                    <th>Logo</th>
                                    <th>Description</th>
                                    <th>Action</th>
                            ...
                            <tbody>
                                @foreach ($business as $item)
                                    <tr>
                                        ...
                                        <td><img src="{{asset($item->logo)}}" class="img-thumbnail" width="70" style="height: 40px"></td>
