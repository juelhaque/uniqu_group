...
@section('content')
    <section class="content-header">
        <div class="container-fluid my-2">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Governence Information</h1>
                </div>
                <div class="col-sm-6 text-right">
                    <a href="{{ route('governence.create') }}" class="btn btn-primary">New Governence Create</a>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="card">
                                ...
                                @foreach ($governence as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('governence.delete', $item->id) }}"
                ...
                <div class="card-footer clearfix d-flex justify-content-end">
                    {{ $governence->links('pagination::bootstrap-4') }}
                </div>
            </div>
        </div>
    </section>
